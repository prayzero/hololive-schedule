...
const pickups = [
  {
    ...
    scheduleNote:
      "2026년 8월 7일 11시부터 등장합니다. 두 카드를 획득하면 각각 파크 의상과 라이브 의상도 함께 획득합니다. 종료 시각과 제공 비율은 공식 X에 공개되지 않아 게임 내 공지에서 확인해야 합니다. 신규 멤버는 다음 개최 예정 가챠부터도 등장하며 상시 홀로드리 가챠에서는 배출되지 않습니다.",
...
const payload = {
  checkedAt: "2026-08-07T11:11:40+09:00",
  sourceUrl: "https://www.hololive-dreams.com/en",
  officialNewsUrl: "https://hololive.hololivepro.com/en/news/20260723-01-401/",
  sourceNote:
    "hololive Dreams 공식 사이트에 공개된 출시 캐릭터 54명과 공식 썸네일을 사용합니다. 로스터·다운로드 링크와 현재 픽업은 공식 웹·X에서 2026-08-07 재확인했고, 개별 제공 비율은 게임 내 제공 비율 화면을 기준으로 2026-07-29 확인했습니다. 8월 7일 신규 미코·스이세이 픽업의 종료 시각과 제공 비율은 외부 공식 채널에 공개되지 않아 확인 중으로 표시합니다.",
  ...
  gachaRates: {
    ...
    pickupReferenceUrl: "https://x.com/hololive_dreams/status/2085547563827302723",
